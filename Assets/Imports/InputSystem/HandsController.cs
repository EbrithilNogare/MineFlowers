...
public partial class @HandsController : IInputActionCollection2, IDisposable
{
    ...
    {
        private @HandsController m_Wrapper;
        public PlayerActions(@HandsController wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @HandsController m_Wrapper;
        public SpiralActions(@HandsController wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @HandsController m_Wrapper;
        public UIActions(@HandsController wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @HandsController m_Wrapper;
        public HandsActions(@HandsController wrapper) { m_Wrapper = wrapper; }
